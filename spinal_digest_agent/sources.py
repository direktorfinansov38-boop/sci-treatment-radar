...
_RU_SCI_KEYWORDS = frozenset([
    # стемы — работают во всех падежах русского языка
    "спинного мозг",   # спинного мозга/мозгу/мозге
    "спинной мозг",    # именительный
    "спинном мозг",    # в спинном мозге
    "стволовы",        # стволовые/стволовых/стволовыми клетки
    "клеточной терап", # клеточной терапии
    "клеточная терап", # клеточная терапия
    "нейростимул",     # нейростимуляция/нейростимуляции
    "экзоскелет",
    "параплег",        # параплегия/параплегии
    "тетраплег",
    "нейроинтерфейс",
    "нейромат",
    "матриселф",
    "трансплантац",    # клеточная трансплантация во всех падежах
    "мезенхимальн",    # мезенхимальные/мезенхимальных
    "экзосом",         # экзосомы/экзосом
    "регенерац",       # регенерация/регенерации
])
